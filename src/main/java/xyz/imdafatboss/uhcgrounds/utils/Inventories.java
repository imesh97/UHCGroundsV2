...
public class Inventories {
    ...
    public static String halfInv(Inventory inv){
        ...
        return AdvancedInventories.toBase64(inv);

    }

    public static String armorInv(ItemStack[] itemStacks){

        return AdvancedInventories.itemStackArrayToBase64(itemStacks);
    ...
    public static ItemStack[] getArmor(String data){
        ...
        try{
            return AdvancedInventories.itemStackArrayFromBase64(data);
        }catch (Exception e){
            return null;
        }
    ...
    public static Inventory getInv(String data){
        ...
        try {
            ...
            return AdvancedInventories.fromBase64(data);
    ...
    public static class AdvancedInventories {
         ...
         * <p />
         *
         * Based off of {@link #toBase64(org.bukkit.inventory.Inventory)}.
         *
